// Redesigned by telegram.dog/Xalbien at https://www.npmjs.com/package/@googledrive/index which was written by someone else, credits are given on Source Page.
// v2.3.7
            ...
            .then(function (obj) {
                ...
                if (mimeType === "application/vnd.google-apps.folder") {
                    ...
                    if (mimeType.includes("video") || video.includes(fileExtension)) {
                        file_video(name, encoded_name, size, UI.poster, url, mimeType, file_id, cookie_folder_id);
